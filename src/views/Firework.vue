...
<template>
  ...
  let waterTexture = new THREE.TextureLoader()
  .load(waterSrc,(texture)=> {
    texture.wrapS = THREE.RepeatWrapping;
    texture.wrapT = THREE.RepeatWrapping;
  })
  
  let newYearScr = new URL('@/images/model/newyears_min.glb',import.meta.url).href
  let gilfLoader = new GLTFLoader()
  gilfLoader.load(
    newYearScr,
    (gltf)=> {
      // console.log(gltf,'gggggggg')
      scene.add(gltf.scene)
  ...
  onBeforeUnmount(() => {
    window.removeEventListener("click", createFirework);
  })
