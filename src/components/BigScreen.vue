<template>
    <div id="bigScreen">
        <div class="header">超宇智慧城市管理系统平台</div>
        <div class="main">
            <div class="left">
                ...
                <h1>
                    <img src="@/images/assets/bg/bar.svg" class="icon" />
...
const imgs = {
  电力: new URL("@/images/assets/bg/dianli.svg",import.meta.url).href,
  火警: new URL("@/images/assets/bg/fire.svg",import.meta.url).href,
  治安: new URL("@/images/assets/bg/jingcha.svg",import.meta.url).href
};
...
.left {
  ...
  background-image: url(@/images/assets/bg/line_img.png);
  background-repeat: no-repeat;
...
.cityEvent {
  ...
  background-image: url(@/images/assets/bg/bg_img03.png);
