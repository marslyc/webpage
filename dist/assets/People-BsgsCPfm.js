import{S as H,r as B,T as P,H as w,_ as U,$ as k,C as E,g as G,M as N,q as W,W as A,v as D,l as J}from"./three.module-BUZdne6h.js";import{O as F}from"./OrbitControls-UBkTBaol.js";import{G as O}from"./GLTFLoader-DwfIB8W0.js";import{r as q,o as X,c as I,a as Z}from"./index-CvBKhgFj.js";const re={__name:"People",setup($){let m=q();const t=new H,a=new B(75,window.innerWidth/window.innerHeight,.1,50);a.position.set(0,0,10),t.add(a);let g=new URL("/assets/color-lrtiHrXO.jpg",import.meta.url).href,x=new URL("/assets/normal-CeJmrFHk.jpg",import.meta.url).href,s=new P,h=s.load(g),S=s.load(x),o={uTime:{value:0}},d=new w({map:h,normalMap:S});d.onBeforeCompile=e=>{e.uniforms.uTime=o.uTime,e.vertexShader=e.vertexShader.replace("#include <common>",`
    #include <common>
